...
The hardware will also send information back to the operating system. And this in turn is sent back to the application. See [[diagram_1.18]] for a visual representation of this process.
